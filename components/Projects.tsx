...
export default function Projects() {
  ...
  return (
    <section
      id="projects"
      className="w-full scroll-mt-[5rem] bg-[#F9F9F9] px-4 py-[7.5rem] pb-[9rem] sm:scroll-mt-[10rem] md:px-0"
    >
      <div className="mx-auto max-w-4xl py-0 text-center">
        ...
        <div className="space-y-6">
          ...
          {projects.length > MAX_PROJECTS && !showMore && (
            <div className="mt-10 flex justify-center">
              <button
                className="cursor-pointer rounded-md border border-gray-300 px-3 py-1.5 text-lg"
          ...
          {showMore && (
            <div className="animate-fadeInFromTop space-y-6">
              {projects.slice(MAX_PROJECTS).map((project) => (
                <a
                  key={project.title}
                  href={project.path}
                  target="_blank"
