  ...
  return (
    <ToolLayout title="Text Compare / Diff Tool">
      <div className="flex flex-col rounded-2xl border border-dashed border-white/15 bg-neutral-950/40 p-6 backdrop-blur-sm">
        <h2 className="mb-2 text-lg font-semibold text-neutral-100">Text A</h2>
      ...
      <div className="flex flex-col rounded-2xl border border-dashed border-white/15 bg-neutral-950/40 p-6 backdrop-blur-sm">
        <h2 className="mb-2 text-lg font-semibold text-neutral-100">Text B</h2>
      ...
      <div className="z-10 overflow-auto rounded-2xl border border-dashed border-white/15 bg-neutral-950/40 p-6 text-neutral-100 backdrop-blur-sm">
        <div className="flex flex-col items-center justify-between sm:flex-row sm:gap-4">
          <h2 className="mb-2 text-lg font-semibold text-white">Differences</h2>
